...
import wx
FAJL = "C:\\Users\\Szalamandra\\Documents\\szf\\egressy\\python\\wxgladesprogik\\wxglade_env\\grafikusSzoftver\\london uj\\src\\london.txt"
KIIRF = "london2.txt"
...
def javit(eredmenyek, KIIRF):
    with open(KIIRF, "w", encoding="utf-8") as f:
        for ered in eredmenyek:
            ...
            f.write(str(ered))
    f.close()
    wx.MessageBox('Szépen kijavítottam', "jelentés", wx.ICON_INFORMATION)
